                    ...
                    for (const productId of Object.keys(product)) {
                        ...
                        try {
                            ...
                            const productCreateData = {
                                ...
                                maximumWattage: productData.specificationsTable?.["Maximum wattage"] || null,
                                brandOfLed: productData.specificationsTable?.["Brand Of Led"] || null,
                                luminousFlux: productData.specificationsTable?.["Luminous Flux"] || null,
                                mainMaterial: productData.specificationsTable?.["Main Material"] || null,
                                cri: productData.specificationsTable?.CRI || null,
                                beamAngle: productData.specificationsTable?.["Beam Angle"] || null,
                                workingTemperature: productData.specificationsTable?.["Working Temperature"] || null,
                                fixtureDimmable: productData.specificationsTable?.["Fixture Dimmable"] || null,
                                electrical: productData.specificationsTable?.Electrical || null,
                                powerFactor: productData.specificationsTable?.["Power Factor"] || null,
                                colorTemperature: productData.specificationsTable?.["Color Temperature"] || null,
                                ip: productData.specificationsTable?.IP || null,
                                energySaving: productData.specificationsTable?.["Energy Saving"] || null,
                                lifeTime: productData.specificationsTable?.["Life Time"] || null,
                                maxIP: productData.MaxIP ? parseInt(productData.MaxIP) : null,
                                ...
                                productColor: productData.specificationsTable ? determineProductColor(productData) : ProductColorTemp.warm,
                                productIp: productData.specificationsTable ? determineProductIp(productData) : ProductIP.IP20,
                                ...
                                hNumber: productData.Hnumber || productData.specificationsTable?.Hnumber || productData.specificationsTable?.["Hnumber"] || null,
