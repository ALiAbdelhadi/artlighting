...
export async function generateMetadata({
  ...
  const description = `Discover the ${product.productName}, a ${wattage}W ${product.sectionType} ${product.lightingtype.name.toLowerCase()} perfect for ${product.category.name.toLowerCase()} applications. ${
    isOutdoor
