...
const LightingTypePage: React.FC<LightingTypePageProps> = ({ children, products, subCategory, lightingType }) => {
    const variants = {
    ...
    return (
        ...
        >
            ...
            <div className="py-11 md:py-15 lg:py-19">
                <Container >
                    <h1 className="capitalize font-bold md:text-3xl sm:text-2xl text-xl">Mister Led {subCategory} - {lightingType}</h1>
