...
export default function PrivacyContnet() {
    const variants = {
                ...
                <Container className=" max-w-6xl">
                    <div className="grid gap-12">
                        ...
                        <div className="grid gap-8">
                            <div>
                                <h2 className="text-2xl font-bold">1. Personal Data Collection</h2>
                                <div className="mt-6 space-y-6">
                                    <div>
                                        ...
                                        <p className="mt-2 text-muted-foreground">
                                            We collect personal information when you create an account or make a purchase on our website. This may include:
                                        </p>
                                        <ul className="list-disc list-inside mt-2 text-muted-foreground">
                                            ...
                                            <li>Any other personal information provided during account creation or purchases</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="mt-6 space-y-6">
                                    <div>
                                        ...
                                        <ul className="list-disc list-inside mt-2 text-muted-foreground">
                                            ...
                                            <li>To send promotional offers and updates about our products (with your consent)</li>
                                            <li>To communicate with you about your orders or account</li>
                                            <li>To analyze and improve our services and product offerings</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <h2 className="text-2xl font-bold">3. Sharing Data with Third Parties</h2>
                                <div className="mt-6 space-y-6">
                                    <div>
                                        <h3 className="text-lg font-semibold">
                                        ...
                                        <p className="mt-2 text-muted-foreground">
                                            We ensure that any third parties we share data with are bound by confidentiality agreements and are required to respect the security of your personal data.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="mt-6 space-y-6">
                                    <div>
                                        ...
                                        <ul className="list-disc list-inside mt-2 text-muted-foreground">
                                            ...
                                            <li>Strict confidentiality agreements with any third parties who may have access to your data</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="mt-6 space-y-6">
                                    <div>
                                        ...
                                        <p className="mt-2 text-muted-foreground">
                                            We're available Saturday - Thursday, 9.30am to 5.30pm, and we'll do our best to respond to your inquiry as quickly as possible.
                                        </p>
                                    </div>
                                </div>
                            </div>
