                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {brands.map((brand) => (
                        ...
                        >
                            ...
                            <p className="text-muted-foreground  text-center mb-4 leading-relaxed">{brand.description}</p>
                            {(brand.name === "Balcom" || brand.name === "Mister LED") && (
                                <Link href={brand.link} className="inline-flex items-center text-primary font-medium hover:text-primary-dark">
