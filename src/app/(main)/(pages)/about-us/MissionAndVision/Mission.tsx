...
function Mission() {
    return (
        <div className="py-16">
            <Container>
                <div className={`flex my-[0] flex-col md:max-w-screen-lg w-full space-y-12`}>
                    <div className="space-y-4">
                        <h2 className="md:text-4xl text-2xl text-primary font-semibold">Our Mission</h2>
                        <h3 className="md:text-3xl text-2xl font-medium">
                            Our mission is to recognize the world about the actual lighting
                        </h3>
                    </div>
                    <div className="space-y-4">
                        <h2 className="md:text-4xl text-3xl text-primary font-semibold">Our Vision</h2>
