...
function About() {
    ...
    useEffect(() => {
        ...
        const timelineElements = sectionRef.current.querySelectorAll('.animate-timeline');
                ...
                <div className="grid gap-10 lg:grid-cols-[1fr_500px]">
                    <div className="grid gap-4">
                        <div className="space-y-4 animate-element">
                            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">About Our
                                Company</h2>
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                            ...
                            <div className="bg-gray-100 dark:bg-neutral-900 rounded-lg p-6 animate-element">
                                ...
                                <p className="text-muted-foreground mt-2">
                                    Integrity, Collaboration, Creativity, and Continuous Improvement.
                                </p>
                            </div>
                            <div className="bg-gray-100 dark:bg-neutral-900 rounded-lg p-6 animate-element">
                                <h3 className="text-lg font-semibold text-primary">Our Team</h3>
                                <p className="text-muted-foreground mt-2">
                                    A diverse group of talented individuals who are passionate about making a
                                    difference.
                                </p>
                            </div>
                            <div className="bg-gray-100 dark:bg-neutral-900 rounded-lg p-6 animate-element">
                                <h3 className="text-lg font-semibold text-primary">Our Commitment</h3>
                                <p className="text-muted-foreground mt-2">
                    ...
                    <div className="relative animate-element">
                        <div
                            ...
                            <div className="grid grid-cols-[auto_1fr] gap-1 text-sm relative animate-timeline">
                                <div className="mt-[3px] aspect-square w-3 bg-primary rounded-full z-10 " />
                                <div className="font-medium mt-[-1px]">2013 - Breakthrough Innovation</div>
                            </div>
                            <div className="grid grid-cols-[auto_1fr] gap-1 text-sm relative animate-timeline">
                                <div className="mt-[3px] aspect-square w-3 bg-primary rounded-full z-10 " />
                                <div className="font-medium mt-[-1px]">2014 - Local Expansion and Acquisition</div>
                            </div>
                            <div className="grid grid-cols-[auto_1fr] gap-1 text-sm relative animate-timeline">
                                <div className="mt-[3px] aspect-square w-3 bg-primary rounded-full z-10 " />
                            ...
                            <div className="grid grid-cols-[auto_1fr] gap-1 text-sm relative animate-timeline">
                                <div className="mt-[3px] aspect-square w-3 bg-primary rounded-full z-10 " />
                                <div className="font-medium mt-[-1px]">2016 - Art Lighting Working with Military </div>
                            </div>
                            <div className="grid grid-cols-[auto_1fr] gap-1 text-sm relative animate-timeline">
                                <div className="mt-[3px] aspect-square w-3 bg-primary rounded-full z-10 " />
                                <div className="font-medium mt-[-1px]">2020 - Pandemic Response and Resilience</div>
                            </div>
                            <div className="grid grid-cols-[auto_1fr] gap-1 text-sm relative animate-timeline">
                                <div className="mt-[3px] aspect-square w-3 bg-primary rounded-full z-10 " />
                                <div className="font-medium mt-[-1px]">2023 - Our Factory completed</div>
                            </div>
                        </div>
                    </div>
                </div>
