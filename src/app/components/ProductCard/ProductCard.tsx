  ...
  const handleAddToCart = () => {
    ...
    startTransition(async () => {
      try {
        ...
        toast({
          title: <span className="text-base text-primary">Added to cart</span>,
          description: (
            <span className="text-sm text-muted-foreground">
    ...
    <div className={`${styles.productItem} select-none `}>
      ...
      <div className={styles.productContent}>
        ...
        <div className={styles.textContainer}>
          ...
          <p
            className={`${styles.textParagraph} text-muted-foreground  font-medium capitalize`}
          >
        ...
        <div className={`${styles.buttons} flex justify-end pt-[10px] w-full`}>
          ...
          <span className={styles.AddToCardContainer}>
            ...
            >
              <AddToCardIcon Fill="currentColor" width={20} height={20} />
            </Button>
          </span>
        </div>
      </div>
