...
const ColorTemperatureSection: React.FC<ColorTemperatureSectionProps> = ({
    specificationsTable,
}) => (
    <div>
        {specificationsTable["Color Temperature"]?.includes("3000K") && (
            <ul>
                ...
                <li className="text-muted-foreground md:text-lg text-[1.1rem] md:leading-9 leading-6 tracking-wide">
                    {createStrongForListItem("Not recommended for office use")} : The soft, warm glow of the LED ceiling
                    lights may be too relaxing and inviting for office environments.
                </li>
        ...
        {specificationsTable["Color Temperature"]?.includes("4000K") && (
            <ul>
                ...
                {createListItemWithStrong("Creates a vibrant and energetic atmosphere.")}
            </ul>
        )}
        {specificationsTable["Color Temperature"]?.includes("6500K") && (
            <ul>
                ...
                <li className="text-muted-foreground md:text-lg text-[1.1rem] md:leading-9 leading-6 tracking-wide">
                    {createStrongForListItem("Recommended for")} : study spaces and offices as it aids in maintaining
                    focus during work.
                </li>
                {createListItemWithStrong(
...
export default ColorTemperatureSection;
