  ...
  const removeItem = async (itemId: string) => {
    try {
      ...
      if (response.ok) {
        ...
        toast({
          title: <span className="text-primary text-base">Item removed</span>,
          description: (
    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent className="flex flex-col w-full sm:max-w-lg z-50 custom-scrollbar">
        <SheetHeader className="border-b pb-4 -mb-4 ">
          <SheetTitle className="sm:text-2xl text-xl font-bold">
            Your Cart
          </SheetTitle>
        </SheetHeader>
        <div className="flex-grow overflow-y-auto">
          {isSignedIn ? (
            ...
            <div className="flex flex-col items-center justify-center h-full">
              ...
              <p className="text-gray-500 mb-4">
                Please sign in to access your cart and start shopping
              </p>
